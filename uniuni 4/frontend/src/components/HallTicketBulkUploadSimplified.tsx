...
import { Upload, FileText, CheckCircle, XCircle, AlertTriangle, RefreshCw, FileSpreadsheet, Users, Building } from 'lucide-react';
...
const HallTicketBulkUploadSimplified: React.FC = () => {
  ...
  const API_BASE_URL = 'http://localhost:3001/api/hall-tickets-v2';
  ...
  // Direct bulk upload and processing
  const startBulkProcessing = async () => {
    ...
    try {
      ...
      console.log('Starting direct bulk upload:', {
    ...
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          CSV will be validated automatically during processing
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className={`text-center font-medium ${getStatusColor(currentJob.status)}`}>
              ...
              {currentJob.status === 'COMPLETED' && `✅ Processing completed! ${currentJob.successRows} successful, ${currentJob.failedRows} failed`}
...
export default HallTicketBulkUploadSimplified;